...
class player(actor):
    ...
    def inputparser(self):
      ...
      while self.health>0 or self.dict1['SlYTHEIN DORM']['creatures'].health<=0:
          ...
          if userinput in ['N','S','E','W']:
              ...
              elif noun in list(self.gameitems) and verb in self.gameitems[noun]['STATS']['verb'] and self.gameitems[noun]['STATS']['FIGHT']==0:
                  self.useitem(noun)
              elif self.dict1[self.location]['characters']!='' and len(inp)==3:
                  (noun.split()[-1]==(self.dict1[self.location]['characters']).name) and (noun.split()[0] in textitemarray)
                  
                  self.dict1[self.location]['characters'].takedamage(self.gameitems[noun.split()[0]]['STATS']['physicaldmg'],self.gameitems[noun.split()[0]]['STATS']['magicaldmg'])
             
              elif self.dict1[self.location]['creatures']!='' and len(inp)==3:
                  noun.split()[-1]==(self.dict1[self.location]['creatures']).name and (noun.split()[0] in textitemarray)
                  
                  self.dict1[self.location]['creatures'].takedamage(self.gameitems[noun.split()[0]]['STATS']['physicaldmg'],self.gameitems[noun.split()[0]]['STATS']['magicaldmg'])    
